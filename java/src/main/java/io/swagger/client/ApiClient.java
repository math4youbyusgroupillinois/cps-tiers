...
public class ApiClient {
    ...
    private String basePath = "https://virtserver.swaggerhub.com/erichilarysmithsr/Yellowtextbook/1.0.0";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://virtserver.swaggerhub.com/erichilarysmithsr/Yellowtextbook/1.0.0
